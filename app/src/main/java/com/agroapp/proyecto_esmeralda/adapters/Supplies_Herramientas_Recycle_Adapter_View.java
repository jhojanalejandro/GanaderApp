...
public class Supplies_Herramientas_Recycle_Adapter_View extends RecyclerView.Adapter<Supplies_Herramientas_Recycle_Adapter_View.Part_Supplies_viewhollder> {
    private Context contextt;
    private int layout_resur;
    ArrayList<Insumo_Finca_Model> Supplies_lArrayList;

    public Supplies_Herramientas_Recycle_Adapter_View(Context contextt, int layout_resur, ArrayList<Insumo_Finca_Model> Supplies_lArrayList) {
    ...
    public class Part_Supplies_viewhollder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public Part_Supplies_viewhollder(@NonNull View itemView) {
            ...
            tv_nombre = itemView.findViewById(R.id.tv_insumos_n_producto_herra);
            tv_cant_insumo = itemView.findViewById(R.id.tv_item_droga_cant_herra);
            tv_precio = itemView.findViewById(R.id.tv_item_cant_precio_herramienta);
        }
