...
public class Deseas_View_Fragment_p_animal_m extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.deseas_view_fragment_p_animal_m, container, false);
        ...
        if (farm_name != null && id_animal != null){
            CollectionReference[] registro_animal_array = share_references_interface.referencedb_c(id_propietario, farm_name, id_animal);
            CollectionReference registro_animal_ref = registro_animal_array[1];
            recyclerView = view.findViewById(R.id.recycle_p_animal_m_deseas_macho);
            ...
            perfil_animal_interface.mostrar_registros_animal( id_animal, "enfermedad", list_common_data_type, common_data_viewhollder);
        }
