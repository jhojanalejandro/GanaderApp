...
import com.agroapp.proyecto_esmeralda.adapters.Produccion_Pesaje_Recycle_Anmls_Adapter;
...
public class Produccion_Pesaje_View_Fragment_p_animal extends Fragment {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    private String id_animal, farm_name, id_doc, id_propietario,kilos_ganados_detete = "0",kilos_ganados_ingreso = "0", kilos_ganados_posingreso = "0",kilos_ganados_presalida = "0",kilos_ganados_salida = "0";
    private View view;
    private Pesaje_Animal_Model pesaje_carne;
    Share_References_interface share_references_interface;
    Produccion_Pesaje_Recycle_Anmls_Adapter pesaje_viewhollder;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_produccion_pesaje_p_animal, container, false);
        ...
        tv_fecha_nacimineto = view.findViewById(R.id.tv_p_animal_fecha_nacimieto);
        tv_fecha_destete = view.findViewById(R.id.tv_p_animal_fecha_destete);
        tv_fecha_ingreso = view.findViewById(R.id.tv_p_animal_fecha_ingreso);
        tv_fecha_presalida = view.findViewById(R.id.tv_p_animal_fecha_presalida);
        tv_fecha_posingreso = view.findViewById(R.id.tv_p_animal_fecha_posingreso);
        tv_fecha_salida = view.findViewById(R.id.tv_p_animal_fecha_salida);
        tv_kilos_presalida = view.findViewById(R.id.tv_p_animal_peso_presalida);
        tv_kilos_nacimiento = view.findViewById(R.id.tv_p_animal_peso_nacimineto);
        tv_kilos_posingreso = view.findViewById(R.id.tv_p_animal_peso_posingreso);
        tv_kilos_ingreso = view.findViewById(R.id.tv_p_animal_peso_ingreso);
        tv_kilos_ganados_ingreso = view.findViewById(R.id.tv_p_animal_peso_ganado_ingreso);
        tv_kilos_ganados_salida = view.findViewById(R.id.tv_p_animal_peso_ganado_salida);
        tv_kilos_ganados_destete = view.findViewById(R.id.tv_p_animal_peso_ganado_destete);
        tv_kilos_ganados_presalida = view.findViewById(R.id.tv_p_animal_peso_ganado_presalida);
        tv_kilos_ganados_posingreso = view.findViewById(R.id.tv_p_animal_peso_ganado_posingreso);
        tv_kilos_salida = view.findViewById(R.id.tv_p_animal_peso_salida);
        tv_kilos_destete = view.findViewById(R.id.tv_p_animal_peso_destete);
        tv_obs = view.findViewById(R.id.tv_p_animal_pesaje_obs);
