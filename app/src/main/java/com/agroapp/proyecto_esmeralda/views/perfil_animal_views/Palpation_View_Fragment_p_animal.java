...
public class Palpation_View_Fragment_p_animal extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.palpation_view_fragment_p_animal, container, false);
        ...
        if (farm_name != null && id_animal != null){
            ...
            CollectionReference registro_animal_ref = registros_ref_array[1];            recyclerView = view.findViewById(R.id.recycle_p_animal_palpacion_view);
            ...
            perfil_animal_interface.mostrar_registros_animal( id_animal,  "palpacion", list_common_data_type, common_data_viewhollder);
        }
        return view;
    }
