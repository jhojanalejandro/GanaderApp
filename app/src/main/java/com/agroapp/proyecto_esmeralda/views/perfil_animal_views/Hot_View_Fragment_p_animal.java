...
public class Hot_View_Fragment_p_animal extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_send_p_animal, container, false);
        ...
        if (farm_name != null && id_animal != null) {
            ...
            recyclerView = view.findViewById(R.id.recycle_p_animal_hot_view);
            ...
            perfil_animal_interface.mostrar_registros_animal( id_animal, "calor", list_common_data_type, common_data_viewhollder);
        }
        return view;
    }
