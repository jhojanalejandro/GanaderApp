...
public class Vaccination_View_Fragment_p_animal extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.vaccination_view_fragment_p_animal, container, false);
        ...
        if (farm_name != null && id_animal != null){
            ...
            recyclerView = view.findViewById(R.id.recycle_p_animal_vaccination_view);
