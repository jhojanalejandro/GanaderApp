...
public class Deseas_View_Fragment_p_animal extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_enfermedad_p_animal, container, false);
        ...
        if (farm_name != null && id_animal != null){
            recyclerView = view.findViewById(R.id.recycle_p_animal_deseas_view);
            ...
            perfil_animal_interface = new Perfil_animal_Presenter(getContext(),recyclerView,registro_animales, layoutManager);
